      ...
      if(Object.keys(examples).length > 0) {
        if(visualisation){
          ...
          if (typeof datasets !== 'undefined' && datasets !== null && datasets.length > 0){
            ...
            while(visualisationHtmlFile.indexOf("dataLineChart") >= 0 && iteratorLineChart < datasets.length) {
              visualisationHtmlFile = visualisationHtmlFile.replace("dataLineChart", datasets[iteratorLineChart].join());
              iteratorLineChart++;
            }
            var iteratorBarChart = 0;
            while(visualisationHtmlFile.indexOf("dataBarChart") >= 0 && iteratorBarChart < datasets.length) {
...
exports.getCIF = function(args, res, next) {
	exports.getOperation(args, res, next); 
}
exports.getCodigo = function(args, res, next) {
	exports.getOperation(args, res, next); 
}
exports.getComarca = function(args, res, next) {
	exports.getOperation(args, res, next); 
}
exports.getDireccion = function(args, res, next) {
	exports.getOperation(args, res, next); 
}
exports.getEmail = function(args, res, next) {
	exports.getOperation(args, res, next); 
}
exports.getFax = function(args, res, next) {
	exports.getOperation(args, res, next); 
}
exports.getLatitud = function(args, res, next) {
	exports.getOperation(args, res, next); 
}
exports.getLocalidad = function(args, res, next) {
	exports.getOperation(args, res, next); 
}
exports.getLongitud = function(args, res, next) {
	exports.getOperation(args, res, next); 
}
exports.getNombre = function(args, res, next) {
	exports.getOperation(args, res, next); 
}
exports.getRegimen = function(args, res, next) {
	exports.getOperation(args, res, next); 
}
exports.getServicios_complementarios = function(args, res, next) {
	exports.getOperation(args, res, next); 
}
exports.getTelefono = function(args, res, next) {
	exports.getOperation(args, res, next); 
}
exports.getTitularidad = function(args, res, next) {
	exports.getOperation(args, res, next); 
}
exports.getWeb = function(args, res, next) {
	exports.getOperation(args, res, next); 
}
